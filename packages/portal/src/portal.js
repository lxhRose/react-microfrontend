...
const project_config = [
  {
    ...
    version: '1.0.0',
    hashPrefix: '',
    entry: IS_DEV ? 'http://localhost:9001/singleSpaEntry.js' : 'main/singleSpaEntry.js',
    store: IS_DEV ? 'http://localhost:9001/store.js' : 'main/store.js'
  }
];
...
async function init() {
  ...
  loadingPromises.push(
    loadApp(
      'main',
      '',
      IS_DEV ? 'http://localhost:9001/singleSpaEntry.js' : 'main/singleSpaEntry.js',
      IS_DEV ? 'http://localhost:9001/store.js' : 'main/store.js'
    )
  );
  ...
  loadingPromises.push(
    loadApp(
      'app1',
      '/app1',
      IS_DEV ? 'http://localhost:9002/singleSpaEntry.js' : 'app1/singleSpaEntry.js',
      IS_DEV ? 'http://localhost:9001/store.js' : 'main/store.js'
    )
  );
  ...
  loadingPromises.push(
    loadApp(
      'app2',
      '/app2',
      IS_DEV ? 'http://localhost:9003/singleSpaEntry.js' : 'app2/singleSpaEntry.js',
      IS_DEV ? 'http://localhost:9001/store.js' : 'main/store.js'
    )
  );
